...
Arguments:
    <base_directory> - The base directory of a AMFeed Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The AMFeed Core developers'
...
Arguments:
    <base_directory> - The base directory of AMFeed Core source code repository.
"""
...
Arguments:
    <file> - A source file in the AMFeed Core repository.
"""

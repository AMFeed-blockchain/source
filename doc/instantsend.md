...
This mechanism has been integrated into Bitcore-Node-AMFeed which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/amfeedpay/insight-api-amfeed#web-socket-api](https://github.com/amfeedpay/insight-api-amfeed#web-socket-api)
* API: [https://github.com/amfeedpay/insight-api-amfeed#instantsend-transactions](https://github.com/amfeedpay/insight-api-amfeed#instantsend-transactions)

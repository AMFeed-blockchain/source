...
This document provides guidelines for internationalization of the AMFeed Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `amfeed_en.ts` remains unchanged.

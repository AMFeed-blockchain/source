...
* amfeed.conf: contains configuration settings for amfeedd or amfeed-qt
* amfeedd.pid: stores the process id of amfeedd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by amfeedd or amfeed-qt

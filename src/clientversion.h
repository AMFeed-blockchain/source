...
//! These need to be macros, as clientversion.cpp's and amfeed*-res.rc's voodoo requires it
...
/**
 * amfeedd-res.rc includes this file, but it cannot cope with real c++ code.

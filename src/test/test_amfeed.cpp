...
#define BOOST_TEST_MODULE AMFeed Test Suite

#include "test_amfeed.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_amfeed_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

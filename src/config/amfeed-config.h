/* src/config/amfeed-config.h.  Generated from amfeed-config.h.in by configure.  */
/* src/config/amfeed-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The AMFeed Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "AMFeed Core"
...
#define PACKAGE_BUGREPORT "https://github.com/amfeedpay/amfeed/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "AMFeed Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "AMFeed Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "amfeedcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://amfeed.org/"

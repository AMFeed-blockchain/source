...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner AMFeed address\n"
            "  payee          - Print the masternode payout AMFeed address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting AMFeed address\n"
        );
}
...
UniValue masternode_outputs(const JSONRPCRequest& request)
{
    ...
    pwallet->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_1123);
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "amfeed",               "masternode",             &masternode,             true,  {} },
    { "amfeed",               "masternodelist",         &masternodelist,         true,  {} },
    { "amfeed",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "amfeed",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};

...
from test_framework.test_framework import AMFeedTestFramework
...
class LLMQCoinbaseCommitmentsTest(AMFeedTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as AMFeedTestFramework doesn't support this atm)

...
official/supported Docker Images found at https://hub.docker.com/r/amfeedpay/amfeedd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/amfeedpay/amfeedd-develop/ when changing the above text**